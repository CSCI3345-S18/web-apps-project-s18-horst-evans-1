...
/** @constructor */
function $c_Lpong_PongMain$() {
  $c_O.call(this)
}
$c_Lpong_PongMain$.prototype = new $h_O();
$c_Lpong_PongMain$.prototype.constructor = $c_Lpong_PongMain$;
/** @constructor */
function $h_Lpong_PongMain$() {
  /*<skip>*/
}
$h_Lpong_PongMain$.prototype = $c_Lpong_PongMain$.prototype;
$c_Lpong_PongMain$.prototype.init___ = (function() {
  return this
});
$c_Lpong_PongMain$.prototype.main__AT__V = (function(args) {
  /*<skip>*/
});
var $d_Lpong_PongMain$ = new $TypeData().initClass({
  Lpong_PongMain$: 0
}, false, "pong.PongMain$", {
  Lpong_PongMain$: 1,
  O: 1
});
$c_Lpong_PongMain$.prototype.$classData = $d_Lpong_PongMain$;
var $n_Lpong_PongMain$ = (void 0);
function $m_Lpong_PongMain$() {
  if ((!$n_Lpong_PongMain$)) {
    $n_Lpong_PongMain$ = new $c_Lpong_PongMain$().init___()
  };
  return $n_Lpong_PongMain$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$m_Lpong_PongMain$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=csci3345-s18-client-fastopt.js.map
